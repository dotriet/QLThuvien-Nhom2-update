...
for (int i=1;i<=g.Columns.Count;i++)
        ...
        private void gbBoLoc_Paint(object sender, PaintEventArgs e)
        {

        }

        private void gbThongKe_Paint(object sender, PaintEventArgs e)
        {

        }

        private void dgvDanhSachCuonSach_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
