...
namespace LibraryManagement.Forms
{
    public partial class formChiTietPhieuMuon : Form
    {
        ...
        {
            detailSlips = new List<CTPhieuMuon>();
        ...
        private void LoadData()
        {
            ...
            string queryCmd = $@"SELECT MaChiTietPhieuMuon, MaCuonSach, TinhTrangPM
                ...
                WHERE PHIEUMUON.MaPhieuMuonSach = '{formDanhSachPhieuMuon.slipCode}' 
            ...
            using (SqlDataReader reader = cmd.ExecuteReader())
            {
                while (reader.Read())
                {
                    CTPhieuMuon slip = new CTPhieuMuon();
            ...
            int stt = 1;
            foreach(CTPhieuMuon borrowSlip in detailSlips)
            {
                borrowSlip.stt = stt;
                stt++;
            }
        ...
        private void dtgv_CellMouseDown(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex != -1)
            {
                ...
                lbSlipCode.Text = formDanhSachPhieuMuon.slipCode;
        ...
        {
            UpdataData();
            formDanhSachPhieuMuon.dataChanged = true;
