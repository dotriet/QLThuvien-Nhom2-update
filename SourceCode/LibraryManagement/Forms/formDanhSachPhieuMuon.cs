...
namespace LibraryManagement.Forms
{
    public partial class formDanhSachPhieuMuon : Form
    {
        ...
        {
            borrowSlips = new List<DSPhieuMuon>();
        ...
        private void LoadData()
        {
            ...
            using (SqlDataReader reader = cmd.ExecuteReader())
            {
                while (reader.Read())
                {
                    DSPhieuMuon slip = new DSPhieuMuon();
            ...
            int stt = 1;
            foreach(DSPhieuMuon borrowSlip in borrowSlips)
            {
                borrowSlip.stt = stt;
                stt++;
            }
        ...
        {
            new formChiTietPhieuMuon().ShowDialog();
        }
