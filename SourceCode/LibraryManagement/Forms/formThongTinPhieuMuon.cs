...
{
    public partial class formThongTinPhieuMuon : Form
    {
        BindingSource bindingChosen;

        public static DSPhieuMuon borrowSlip;
        ...
        {
            if (formChoMuonSach.askBeforePrint)
            {
                PrintSlip();
            }
            UpdataData();
        ...
        private void UpdataData()
        {
            ...
            foreach(Sach book in borrowSlip.chosenBooks)
            {
            ...
            DemoDesign.formChoMuonSach.lendState = "Success";
            //SendMail();
            this.Close();
        }
        ...
        {
            DemoDesign.formChoMuonSach.lendState = "Cancelled";
            this.Close();
        }
